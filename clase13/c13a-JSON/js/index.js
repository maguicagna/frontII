...
function recorrerMiembros() {
    //escribe la lógica
    for (let miembro of datos.members){
      listado.innerHTML += 
      `<li>
        <li> Nombre: ${miembro.name}</li>
        <li> Edad: ${miembro.age}</li>
        <li> Indentidad secreta: ${miembro.secretIdentity}</li>
        <li> Poderes: ${miembro.powers}</li>
      </li>`
